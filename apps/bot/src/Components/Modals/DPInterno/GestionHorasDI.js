...
export default {
  ...
  async execute(interaction, client) {
    ...
    const categoryId = setup.GestionHoras;

    if (!categoryId) {
      return interaction.editReply({
        content: 'No se encontró una categoría asignada para Gestión de Horas.',
      });
    }
    ...
    const ticketChannel = await guild.channels.create({
      ...
      parent: categoryId,
      topic: `Ticket de ${user.tag} | Gestión de Horas`,
