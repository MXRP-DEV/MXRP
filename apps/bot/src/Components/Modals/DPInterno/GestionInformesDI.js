...
export default {
  ...
  async execute(interaction, client) {
    ...
    const categoryId = setup.GestionInformes;

    if (!categoryId) {
      return interaction.editReply({
        content: 'No se encontró una categoría asignada para Gestión de Informes.',
      });
    }
    ...
    const ticketChannel = await guild.channels.create({
      ...
      parent: categoryId,
      topic: `Ticket de ${user.tag} | Gestión de Informes`,
    ...
    const textContent = `📊 **Gestión de Informes**
